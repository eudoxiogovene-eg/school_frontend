...
export default function ComponentMensalidade({nameScreen}){
...
///const [nameScreen,setNameScreen]=useState('')
    ...
    const pages=Math.ceil(mensalidades.length/itensPerpage)
    const startIndex=(currentPage-1) * itensPerpage
    const endIndex= startIndex + itensPerpage
    const currentItens=mensalidades.slice(startIndex,endIndex)
        ...
        <div className={styles.div_geral}>
            <div className={styles.contain} style={{display:displayContainer}} >
                <div className={styles.content_geral}>
                    {currentItens.map(mensalidade=>(
                        
                                <div key={mensalidade._id} className={styles.container}
                                        ...
                                        <div className={styles.container_info}>
                                                    <div className={styles.content}>
                                                                <div className={styles.info_geral}>
                                                                    ...
                                                                    <div className={styles.info}>
                                                                        <div className={styles.info_content}>
                                                                            <h2>nome </h2>
                                                                            <span>{mensalidade.codigoInscricao.nome}</span>
                                                                        </div>
                                                                        <div className={styles.info_content}>
                                                                            <h2>apelido </h2>
                                                                            <span>{mensalidade.codigoInscricao.apelido}</span>
                                                                        </div>
                                                                        <div className={styles.info_content}>
                                                                            <h2>telefone </h2>
                                                                            <span>{mensalidade.codigoInscricao.contactos.contactoPrincipal}</span>
                                                                        </div>
                                                                       
                                                                       
                                                                        <div className={styles.info_content}>
                                                                            <h2>nivel</h2>
                                                                            <span>{mensalidade.codigoCadastro.nivel}</span>
                                                                        </div>
                                                                        <div className={styles.info_content}>
                                                                            <h2>codigo estudante</h2>
                                                                            <span>{mensalidade.codigoCadastro.codigoEstudante}</span>
                                                                        </div>
                                                                        <div className={styles.info_content}>
                                                                            <h2>curso</h2>
                                                                            <span>{mensalidade.curso.nomeCurso}</span>
                                                                        </div>
                                                                        <div className={styles.info_content}>
                                                                            <h2>desconto estudante</h2>
                                                                            <span>{mensalidade.codigoCadastro.desconto}</span>
                                                                        </div>
                                                                    ...
                                                                    <div className={styles.info}>
                                                                        <div className={styles.info_content}>
                                                                            ...
                                                                            <span>{mensalidade.curso.descontoCurso}</span>
                                                                        </div>
                                                                        <div className={styles.info_content}>
                                                                            <h2>data pagamento</h2>
                                                                            <span>{mensalidade.dataPagamento}</span>
                                                                        </div>
                                                                        <div className={styles.info_content}>
                                                                             <h2>forma pagamento</h2>
                                                                            <span>{mensalidade.formPagamento}</span>
                                                                        </div>
                                                                        <div className={styles.info_content}>
                                                                            <h2>valor mensalidade</h2>
                                                                            <span>{mensalidade.valor_mensalidade}</span>
                                                                        </div>
                                                                        <div className={styles.info_content}>
                                                                            <h2> mensalidade</h2>
                                                                            <span>{mensalidade.mensalidade.mes}</span>
                                                                        </div>
                                                                        <div className={styles.info_content}>
                                                                            <h2>ano apagar</h2>
                                                                            <span>{mensalidade.anoPagamento}</span>
                                                                        </div>
                                                                
                                                                        <div className={styles.info_content}>
                                                                            <h2>usuario pagamento</h2>
                                                                            <span>{mensalidade.usuario.username}</span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div className={styles.image}>
                                                                    <img src={mensalidade.codigoInscricao.url || avatar} alt='foto do estudante' />
