...
export default function ComponentMultas({nameScreen}){
...
///const [nameScreen,setNameScreen]=useState('')
    ...
    const pages=Math.ceil(multas.length/itensPerpage)
    const startIndex=(currentPage-1) * itensPerpage
    const endIndex= startIndex + itensPerpage
    const currentItens=multas.slice(startIndex,endIndex)
   ...
   useEffect(()=>{
    ...
    async function listarMultasPagas(){
        try {
        ...
        <div className={styles.div_geral}>
            <div className={styles.contain} style={{display:displayContainer}} >
                <div className={styles.content_geral}>
                    {currentItens.map(multas=>(
                        
                                <div key={multas._id} className={styles.container}
                                        ...
                                        <div className={styles.container_info}>
                                                    <div className={styles.content}>
                                                                <div className={styles.info_geral}>
                                                                    ...
                                                                    <div className={styles.info}>
                                                                        <div className={styles.info_content}>
                                                                            <h2>nome </h2>
                                                                            <span>{multas.codigoInscricao.nome}</span>
                                                                        </div>
                                                                        <div className={styles.info_content}>
                                                                            <h2>apelido </h2>
                                                                            <span>{multas.codigoInscricao.apelido}</span>
                                                                        </div>
                                                                        <div className={styles.info_content}>
                                                                            <h2>telefone </h2>
                                                                            <span>{multas.codigoInscricao.contactos.contactoPrincipal}</span>
                                                                        </div>
                                                                        <div className={styles.info_content}>
                                                                            <h2>curso</h2>
                                                                            <span>{multas.curso.nomeCurso}</span>
                                                                        </div>
                                                                       
                                                                        <div className={styles.info_content}>
                                                                            <h2>nivel</h2>
                                                                            <span>{multas.codigoCadastro.nivel}</span>
                                                                        </div>
                                                                        <div className={styles.info_content}>
                                                                            <h2>codigo estudante</h2>
                                                                            <span>{multas.codigoCadastro.codigoEstudante}</span>
                                                                        </div>
                                                                        <div className={styles.info_content}>
                                                                            <h2>paga com mensalidade</h2>
                                                                            <span>{multas.pagaComMensalidade?"sim":"nao"}</span>
                                                                        </div>
                                                                    ...
                                                                    <div className={styles.info}>
                                                                        <div className={styles.info_content}>
                                                                            ...
                                                                            <span>{multas.createdAt.split("T")[0]}</span>
                                                                        </div>
                                                                        <div className={styles.info_content}>
                                                                            <h2>valor da multa</h2>
                                                                            <span>{multas.codigoIdMulta.valorMulta}</span>
                                                                        </div>
                                                                        <div className={styles.info_content}>
                                                                            <h2>forma pagamento</h2>
                                                                            <span>{multas.formaPagamento}</span>
                                                                        </div>
                                                                        <div className={styles.info_content}>
                                                                            <h2>estado multa</h2>
                                                                            <span>{multas.codigoIdMulta.statusMulta}</span>
                                                                        </div>
                                                                        <div className={styles.info_content}>
                                                                            <h2>curso da mmulta</h2>
                                                                            <span>{multas.curso.nomeCurso}</span>
                                                                        </div>
                                                                        <div className={styles.info_content}>
                                                                            <h2>mes da multa</h2>
                                                                            <span>{multas.mensalidade.mes}</span>
                                                                        </div>
                                                                        <div className={styles.info_content}>
                                                                            <h2>usuario do pagamento</h2>
                                                                            <span>{multas.usuario.username}</span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div className={styles.image}>
                                                                    <img src={multas.codigoInscricao.url || avatar} alt='foto do estudante' />
