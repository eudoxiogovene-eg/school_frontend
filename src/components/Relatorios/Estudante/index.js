...
export default function ComponentEstudante({nameScreen}){
...
///const [nameScreen,setNameScreen]=useState('')
    ...
    const pages=Math.ceil(estudantes.length/itensPerpage)
    const startIndex=(currentPage-1) * itensPerpage
    const endIndex= startIndex + itensPerpage
    const currentItens=estudantes.slice(startIndex,endIndex)
        ...
        <div className={styles.div_geral}>
            <div className={styles.contain} style={{display:displayContainer}} >
                <div className={styles.content_geral}>
                    {currentItens.map(estudante=>(
                        
                                <div key={estudante._id} className={styles.container}
                                        ...
                                        <div className={styles.container_info}>
                                                    <div className={styles.content}>
                                                                <div className={styles.info_geral}>
                                                                    ...
                                                                    <div className={styles.info}>
                                                                        <div className={styles.info_content}>
                                                                            <h2>nome </h2>
                                                                            <span>{estudante.codigoInscricao.nome}</span>
                                                                        </div>
                                                                        <div className={styles.info_content}>
                                                                            <h2>apelido </h2>
                                                                            <span>{estudante.codigoInscricao.apelido}</span>
                                                                        </div>
                                                                        <div className={styles.info_content}>
                                                                            <h2>telefone </h2>
                                                                            <span>{estudante.codigoInscricao.contactos.contactoPrincipal}</span>
                                                                        </div>
                                                                        <div className={styles.info_content}>
                                                                            <h2>bairro</h2>
                                                                            <span>{estudante.bairro.nomeBairro}</span>
                                                                        </div>
                                                                        <div className={styles.info_content}>
                                                                            <h2>data cadastro</h2>
                                                                            <span>{estudante.dataInscricao}</span>
                                                                        </div>
                                                                        <div className={styles.info_content}>
                                                                            <h2>nivel</h2>
                                                                            <span>{estudante.nivel}</span>
                                                                        </div>
                                                                        <div className={styles.info_content}>
                                                                            <h2>codigo estudante</h2>
                                                                            <span>{estudante.codigoEstudante}</span>
                                                                        </div>
                                                                    </div>
                                                                    <div className={styles.info}>
                                                                        <div className={styles.info_content}>
                                                                        ...
                                                                        <div className={styles.info_content}>
                                                                            <h2>taxa inscricao</h2>
                                                                            <span>{estudante.taxaInscricao}</span>
                                                                        </div>
                                                                        <div className={styles.info_content}>
                                                                            <h2>estado</h2>
                                                                            <span>{estudante.estado}</span>
                                                                        </div>
                                                                        <div className={styles.info_content}>
                                                                            <h2>desconto</h2>
                                                                            <span>{estudante.desconto}</span>
                                                                        </div>
                                                                        <div className={styles.info_content}>
                                                                            <h2>forma pagamento</h2>
                                                                            <span>{estudante.formaPagamento}</span>
                                                                        </div>
                                                                        <div className={styles.info_content}>
                                                                            <h2>horario</h2>
                                                                            <span>{estudante.horario}</span>
                                                                        </div>
                                                                        <div className={styles.info_content}>
                                                                            <h2>escola</h2>
                                                                            <span>{estudante.schoolname.nomeEscola}</span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div className={styles.image}>
                                                                    <img src={estudante.codigoInscricao.url || avatar} alt='foto do estudante' />
